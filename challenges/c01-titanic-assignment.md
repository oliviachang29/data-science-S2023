...
- In the 3rd class, approximately the same number of female and male
  passengers survived.
- In the Crew class, more male passengers survived than female
  passengers.
...
- In 3rd class and Crew, the proportion of female passengers that
  survived is greater than the proportion of male passengers that
  survived. In the first plot, the raw count of female and male
  passengers in 3rd class that survived was approximately the same.
- In Crew, the proportion of female passengers that survived (\~0.87) is
  much greater than the proportion of male passengers that survived
  (\~0.23). This is in comparison to the first plot, where the raw count
  of male passengers in Crew that survived is much greater than the raw
  count of female passengers that survived.
- Is there anything *fishy* going on in your plot?
  - Yes. According to the plot, everyone in first class and second class
    survived, but from the `df_prop` tibble we can see that there are
    plenty of first class and second passengers that did not survive.
    For example, there are 118 1st-class male adults that did not
    survive.
...
- If you saw something *fishy* in q4 above, use your new plot to explain
  ...
  - In q4, it appeared that everyone in first and second class survived,
    ...
    proportion (100%) was masking the adult-survival proportion for
    first and second class. Once the graphs were separated by age, we
    can see that the adult proportion of 1st and 2nd class that survived
    was less than 100%.
