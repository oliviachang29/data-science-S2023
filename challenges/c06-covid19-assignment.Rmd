...
- The cases_per100k average is about 5 to 10 times greater for the 10 counties with the highest cases_per100k average than the average cases_per100k across all counties.
- The deaths_per100k average is about 6 to 10 times greater for the 10 counties with the highest deaths_per100k average compared to the average deaths_per100k across all counties.
- The top 10 counties in both calculations both have relatively small populations - all are below 30,000.
