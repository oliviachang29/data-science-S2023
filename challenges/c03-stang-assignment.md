...
- Is there “one true value” for the material properties of Aluminum?
  - It seems that there is no “one true value” for the material
    properties of aluminum, as the values of E (elastic modulus) and nu
    (Poisson’s ratio) vary.
- How many aluminum alloys are in this dataset? How do you know?
  - There is only one unique value for aluminum alloy in this dataset.
    All of the “alloy” values in the dataset are “al_24st”.
- What angles were tested?
  - The angles tested were 0, 45, and 90 degrees.
- What thicknesses were tested?
  - The thicknesses tested were 0.022, 0.032, 0.064, and 0.081. The
    units are unclear
...
- There are two peaks in the distribution of Elastic modulus values, one
  of relatively small height at around E = 10,000 and another of much
  higher height at around E = 10500. More tests could help inform a more
  detailed distribution and determine if there is truly a peak at E =
  10,000 or if that is just this dataset.
...
- Does this graph support or contradict the claim above?
  - The graph suggests that the less thick aluminum blocks have a higher
    elastic modulus. This contradicts the claim above that elastic
    modulus is an intensive property - if it were intensive, the
    thickness should not affect the elastic modulus values. However,
    this evidence is not conclusive as we cannot be sure that it is the
    different thickness that affects the young’s modulus value.
