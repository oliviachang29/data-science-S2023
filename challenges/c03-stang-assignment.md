...
- Does this graph support or contradict the claim above?
  - In general, it seems that the less thick aluminum blocks have a
    higher elastic modulus, based on the graph. This contradicts the
    claim above that elastic modulus is an intensive property - if it
    were intensive, the thickness should not affect the elastic modulus
    values.
