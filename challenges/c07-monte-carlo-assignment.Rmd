...
- Was your sample size $n$ large enough? Why do you say that?
  - The sample size n that I chose was 10,000 points. We are only trying to get a reasonable estimate of pi in order to demonstrate the Monte Carlo theorem, so it does not need to be extremely precise, and the sample size was large enough that a 95% confidence interval did include the true value of pi, so the sample size was large enough for our purposes.
