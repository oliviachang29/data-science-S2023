...
- In general, as carat increases, so does price. However, it is not a clean trend line, as it appears that there are several outliers to this general correlation, where there are diamonds of larger carat but not correspondingly higher price.
...
- Ideal cut diamonds are more generally expensive than fair cut diamonds of the same carat. In general, better cut equals higher price.
