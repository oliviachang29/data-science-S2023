...
* c function creates your own vectors i.e. c(1 2 3)
...
Store results by creating object
```{r}
num <- "b"
num
```
...
ATL is an object, not a string, does not exist yet so can't compare whether the value of airport and ATL are the same
