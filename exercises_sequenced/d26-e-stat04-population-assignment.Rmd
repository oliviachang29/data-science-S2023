...
- q2.1 will produce more accurate estimates - because the standard deviation is smaller the standard error is lower
...
- It is 0.7 vs 1 which is 3/4 of the value
- What accounts for the difference between these values?
- The standard deviation of the sample is different because we are sampling and not getting the whole population
