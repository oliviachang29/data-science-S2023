...
The first couple of rows are formatted to make the spreadsheet look visually "pretty" - so there is some information on the top about intentional homicide and then several blank columns
...
df_q3 <-
  read_excel(filename, sheet = 1, skip = 7, col_names = col_names_undoc, col_types = col_types_undoc)
...
vars_lagged <- c("region", "sub_region")
