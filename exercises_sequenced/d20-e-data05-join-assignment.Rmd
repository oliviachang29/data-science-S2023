...
- The columns were bound together but the dataframes were not in the right order.
...
df_q2 <-
  beatles1 %>%
  left_join(beatles3, by = "name") %>%
  left_join(beatles2, by = "surname")
...
```{r q3-task}
criteria <- expand_grid(month = c(8, 9), dest = c("SFO", "OAK", "SJC"))
