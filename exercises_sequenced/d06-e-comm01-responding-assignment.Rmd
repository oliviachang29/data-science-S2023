...
- Is the bolded response **active** or **passive**? Why? The bolded response is active because it acknowledges the colleague's concern about the axes being unlabeled.
- Is the bolded response **constructive** or **destructive**? Why? The bolded response is constructive as it conveys positive emotion.
...
- Is the bolded response **active** or **passive**? Why? The bolded responsive is passive, as it does not address the substance of the question (what are the axes?).
- Is the bolded response **constructive** or **destructive**? Why? The bolded responsive is constructive, as it conveys positive emotion (as opposed to offense).
- How does this statement make you *feel*, relative to the bolded statement before the q1 prompt? It feels less negative/destructive than the bolded statement before the q1 prompt, but I would feel irritated that the substance of my question wasn't being addressed (i.e. they aren't really paying attention).
...
- Is the bolded response **active** or **passive**? Why? The bolded response is passive, as it does not engage with the substantive content of the graph and instead asks an unrelated question.
- Is the bolded response **constructive** or **destructive**? Why? The bolded response is neither particularly constructive nor destructive; on one hand the colleague demonstrates that they care about the presenter's opinion on the morality of aesthetic diamonds. On the other hand the colleague is demonstrating a disregard for the substance of the graph.
