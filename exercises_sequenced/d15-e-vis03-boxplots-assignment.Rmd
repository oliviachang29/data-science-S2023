...
```{r q1-task}
diamonds %>%
  mutate(carat_cut = cut_interval(carat, n = 5)) %>%
...
**Observations**
- The median price for the lowest-carat interval is much lower than the rest of the carat intervals. There are however many outliers that are above the 3rd quartile in the lowest-carat interval.
- The median price is higher for the middle carat interval than the 4th carat interval, but the middle-carat interval has more outliers below the 1st quartile.
- There is a large median price jump between the 1st and 2nd, and 2nd and 3rd intervals.
...
**Observations**:
- The most common group of cut and color changed to Premium and Color I.
