...
summary(diamonds) gives a sense of the common values + min/max and 1st and 3rd quartiles for each of the numeric variables; for cut, color and clarity, which are not numeric, it gives a tally of each of the types.
...
There are 53,940 items in the diamonds dataset, with 10 different attributes for each item: carat, cut, color, clarity, depth, table, price, x, y, z.
