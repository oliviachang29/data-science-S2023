...
- What value of `fr` did you predict? 50% of the curve should be less than 0?
- Did your prediction match your calculation? No it did not. It is generating a different value (relatively close to 0.5, I have gotten 0.49, 0.56, etc.) each time due to randomness.
...
- What value does `fr` appear to be limiting towards? The frequency value `fr` appears to be limited towards 0.95.
...
- What was your `fr` prediction in __q1__? How does `p0` compare? p0 is the same as my fr prediction in q1!
